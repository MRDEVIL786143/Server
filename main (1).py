...
def login():
    if request.method == 'POST':
        ...
        if username in users and users[username] == password:
            ...
            <head>
              ...
              <title> DEVILXANGEL - ACCESS DENIED</title>
              ...
              <div class="container d-flex justify-content-center align-items-center min-vh-100">
                <div class="terminal-card rounded-lg p-4" style="max-width: 400px;">
                  ...
                  <div class="mt-3 text-center">
                    <small class="matrix-text">Default Credentials: D3V1L X ANGEL/matrix123</small>
                  </div>
                </div>
              </div>
            </body>
    ...
    <head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title> DEVILXANGEL - SYSTEM ACCESS</title>
      <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet">
      <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
      <style>
        @import url('https://fonts.googleapis.com/css2?family=Share+Tech+Mono&display=swap');
    ...
    <body>
      ...
      <div class="container d-flex justify-content-center align-items-center min-vh-100">
        <div class="terminal-card rounded-lg p-4" style="max-width: 400px;">
          <h2 class="text-center header-title mb-4">
            <i class="fas fa-terminal"></i> D3V1L X ANGEL CONVO SYSTEM 
          </h2>
          ...
          <div class="mt-3 text-center">
            <small class="matrix-text">Default Credentials: D3V1L X ANGEL</small>
          </div>
        </div>
      </div>
    </body>
...
<body>
  ...
  <header class="header mt-4">
    <h1 class="mt-3 header-title">
      <i class="fas fa-terminal"></i> DARK D3V1L X ANGEL
    </h1>
    <p class="matrix-text">THE POWERFULL DEVELOPING D3V1L X ANGEL SYSTEM</p>
  </header>
  ...
  <footer class="footer text-center mt-4">
    <p class="matrix-text">© 2026MR D3VIL LEGEND CONVO SYSTEM</p>
    <p>
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=20944)